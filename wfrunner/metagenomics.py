...
def main(args: Namespace):
    logger = get_named_logger("metagenomics")
    
    run(args, logger)
    
def argparser():
    """Argument parser for entrypoint."""
    parser = wf_parser("metagenomics")
    ...
    parser.add_argument("-d", "--database",
                            ...
                            help="Database to use. (default: ncbi_16s_18s)",
                            type=str,
                            )
    ...
    parser.add_argument("-l", "--min-len",
                            dest='length', default=200,
                            help="Lower read length limit. (default: 200)",
                            type=int,
                            )
